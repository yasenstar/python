...
def check_win():
    ...
    if (board_squares[1][0].text == board_squares[1][1].text == board_squares[1][2].text) and board_squares[1][0].text in ["X", "O"]:
        winner = board_squares[1][0]
    if (board_squares[2][0].text == board_squares[2][1].text == board_squares[2][2].text) and board_squares[2][0].text in ["X", "O"]:
        winner = board_squares[2][0]
    
    # Horizontal line
    if (board_squares[0][0].text == board_squares[1][0].text == board_squares[2][0].text) and board_squares[0][0].text in ["X", "O"]:
        winner = board_squares[0][0]
    if (board_squares[0][1].text == board_squares[1][1].text == board_squares[2][1].text) and board_squares[0][1].text in ["X", "O"]:
        winner = board_squares[1][0]
    if (board_squares[0][2].text == board_squares[1][2].text == board_squares[2][2].text) and board_squares[0][2].text in ["X", "O"]:
        winner = board_squares[2][0]
